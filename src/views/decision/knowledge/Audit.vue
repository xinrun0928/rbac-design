...
const statsCards = [
  { key: '全部', label: '全部', value: 3, icon: Document, color: '#409EFF', bgColor: '#ecf5ff' },
  { key: '历史案例', label: '历史案例', value: 1, icon: Notebook, color: '#67C23A', bgColor: '#f0f9eb' },
  { key: '政策法规', label: '政策法规', value: 2, icon: Warning, color: '#E6A23C', bgColor: '#fdf6ec' },
  { key: '专家知识', label: '专家知识', value: 0, icon: MagicStick, color: '#F56C6C', bgColor: '#fef0f0' },
  { key: '标准规范', label: '标准规范', value: 1, icon: Memo, color: '#909399', bgColor: '#f4f4f5' }
]
