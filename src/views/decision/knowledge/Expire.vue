...
const categoryTabs = [
  ...
  { key: '政策法规', label: '政策法规', count: 3, icon: Tickets, color: '#E6A23C', bgColor: '#fdf6ec' },
  { key: '专家知识', label: '专家知识', count: 1, icon: Stamp, color: '#F56C6C', bgColor: '#fef0f0' },
  { key: '标准规范', label: '标准规范', count: 1, icon: Document, color: '#909399', bgColor: '#f4f4f5' }
]
