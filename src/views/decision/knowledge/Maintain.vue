...
const statsCards = [
  { key: '全部', label: '全部', value: 6, icon: Files, color: '#409EFF', bgColor: '#ecf5ff' },
  { key: '历史案例', label: '历史案例', value: 2, icon: Document, color: '#67C23A', bgColor: '#f0f9eb' },
  ...
  { key: '标准规范', label: '标准规范', value: 2, icon: Stamp, color: '#909399', bgColor: '#f4f4f5' }
]
