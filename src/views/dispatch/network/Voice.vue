  ...
  <div class="voice-management">
    <el-card class="table-card animate-item" shadow="never">
      <div class="search-bar">
        <span class="search-bar-title">语音</span>
      ...
      >
        ...
        <el-table-column prop="installLocation" label="安装位置" min-width="130" align="center" show-overflow-tooltip />
...
import { voiceTerminalData } from '@/mock/dispatch/networkData'
import type { VoiceTerminal } from '@/types/dispatch/network'

const tableData = ref<VoiceTerminal[]>([...voiceTerminalData])
...
const handleStartMeeting = (row: VoiceTerminal) => { ElMessage.info(`发起会议：${row.deviceName}`) }
const handleJoinMeeting = (row: VoiceTerminal) => { ElMessage.info(`加入会议：${row.deviceName}`) }

const handleRemove = (row: VoiceTerminal) => {
